      ...
      <div className="space-y-4">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <p className="text-xs font-medium text-brand-600 uppercase tracking-wide">Rent Details</p>
          </div>
              ...
              {CITY_OPTIONS.map(opt => {
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <span className={`text-sm font-semibold ${selected ? 'text-brand-900' : 'text-gray-900'}`}>{opt.label}</span>
                      <p className="text-xs text-gray-500 mt-0.5">{opt.description}</p>
                      <span className="text-xs text-brand-600 font-medium">{opt.tag}</span>
                    </div>
                  </label>
                )
              })}
